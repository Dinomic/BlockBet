...
CREATE SEQUENCE IF NOT EXISTS SEQ_ACCOUNTS START 100;
...
CREATE SEQUENCE IF NOT EXISTS SEQ_AUTHORITIES START 100;
...
CREATE SEQUENCE IF NOT EXISTS SEQ_ACCOUNT_DETAILS START 100;
